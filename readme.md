...
一个插件化、定制化、无广告的免费音乐播放器。Android 版基于 React Native；鸿蒙 NEXT 原生版见 [`harmonyos/`](./harmonyos/README.md)。
...
鸿蒙 NEXT 原生工程在仓库 [`harmonyos/`](./harmonyos/README.md) 目录，使用 DevEco Studio 打开后编译运行。
